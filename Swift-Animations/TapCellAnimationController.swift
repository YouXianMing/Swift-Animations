...
class TapCellAnimationController: NormalTitleViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func setup() {
        ...
        func addText(string : String) {
            ...
            datas.append(ShowTextCell.Adapter(data: model, cellHeight: ShowTextCell.HeightWithData(model)))
        }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        return tableView.dequeueAndLoadContentReusableCellFromAdapter(datas[indexPath.row], indexPath: indexPath)
    }
