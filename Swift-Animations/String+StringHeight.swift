...
extension String {
    ...
    /**
     ...
     - returns: The height.
     */
    func heightWithStringAttributes(_ attributes : [NSAttributedString.Key : Any], fixedWidth : CGFloat) -> CGFloat {
    ...
    /**
     ...
     - returns: The width.
     */
    func widthWithStringAttributes(_ attributes : [NSAttributedString.Key : Any]) -> CGFloat {
